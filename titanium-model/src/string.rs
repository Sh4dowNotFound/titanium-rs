...
impl<'a> Deref for TitanString<'a> {
    type Target = str;
...
impl<'a> fmt::Debug for TitanString<'a> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Debug::fmt(&**self, f)
    }
}

impl<'a> fmt::Display for TitanString<'a> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt::Display::fmt(&**self, f)
    }
}

impl<'a> PartialEq for TitanString<'a> {
    fn eq(&self, other: &Self) -> bool {
        **self == **other
    }
}

impl<'a> PartialEq<str> for TitanString<'a> {
...
impl<'a> PartialEq<String> for TitanString<'a> {
...
impl<'a> std::hash::Hash for TitanString<'a> {
    fn hash<H: std::hash::Hasher>(&self, state: &mut H) {
        (**self).hash(state)
    }
}

impl<'a> Serialize for TitanString<'a> {
...
impl<'de, 'a> Deserialize<'de> for TitanString<'a> {
...
impl<'a> From<String> for TitanString<'a> {
    fn from(s: String) -> Self {
        Self::Owned(s)
    }
}

impl<'a> From<Arc<str>> for TitanString<'a> {
...
impl<'a> Default for TitanString<'a> {
    fn default() -> Self {
        Self::Borrowed("")
    }
}
